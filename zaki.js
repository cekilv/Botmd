...
//FAKE QUOTED
const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@g.us"},"message": {"groupInviteMessage": {"groupJid": "6287772549185-1622678501@g.us","inviteCode": "https://chat.whatsapp.com/CF4jm8T9FVx5MnD037B1nNj","groupName": "Group Official", "caption": `${footer}`, 'jpegThumbnail': ('./media/zaki.jpg')}}}
        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`6289515023118@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
reply(`Sukses Mengirim Report Ke Owner\n\nNOTE:JIKA MENGIRIM TIDAK SESUAI MAKA TIDAK AKAN DI TANGGAPI OLEH OWNER !`)
                    }
                    break 
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'cekil': case 'doge': case 'on': case 'online':{
                anu = `Hi ${pushname} Kak 🤚\nADA YANG BISA SAYA BANTU,TEKAN BUTTON MENU UNTUK MENAMPILKAN FITUR BOT`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                ...
                case 'tolol': case 'bangsat': case 'pepek': case 'kontol': case 'kntl': case 'ppk': case 'mmk': case 'ngentod': case 'asu': case 'jancok': case 'peler':{
                anu = `Hi ${pushname} Kak 🤚\nADA YANG BISA SAYA BANTU,TEKAN BUTTON MENU UNTUK MENAMPILKAN FITUR BOT`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
...
*Saya Cekil Bot,Bot Whatshapp*
Yang Membantu Kamu untuk Mempermudah Sesuatu
Seperti Membuat Sticker Dan Lainya
`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: txt.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `${footer1}`, hydratedButtons: [{ urlButton: { displayText: 'Website', url: 'https://cekilgans.github.io'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }, { quickReplyButton: { displayText: 'Command', id: 'allmenu', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
break
case 'command': case 'allmenu': case 'listmenu': {
var butonnya =
[{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/CF4jm8T9FVx5MnD037B1nN'} }, 
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: `${ccomannya}`, locationMessage: { jpegThumbnail: fs.readFileSync('./media/allmenu.jpg') }, hydratedFooterText: `${footer}`, hydratedButtons: [{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/CF4jm8T9FVx5MnD037B1nN'} }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
...
break
case 'ssweb': {
if (!args[0]) return reply(`Example : \n${prefix + command} https://instagram.com/cekilgans`)
